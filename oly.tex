...
\prob{1}{AoPS Forum}{$a,b \in N$ and $ab\mid (a^2 + b^2)$, then prove that $a = b$.}
...
\end{sol}
\prob{1}{AoPS Forum}{Let $a$ and $b$ be positive integers such that $a|b^2$, $b^2|a^3$, $a^3|b^4$, $b^4|a^5$, $\cdots$. Prove that $a=b$.}
...
\prob{1}{Euler}{Prove that all factors of $2^{2^{n+ 1}}$ are of the form $k \cdot 2^{n+1} + 1$.}
...
\prob{2}{Folklore}{Let $p > 5$ be a prime. In terms of $p$, compute the remainder when
$$\prod_{i=1}^{p-1} (i^2+1)$$
is divided by $p$}
